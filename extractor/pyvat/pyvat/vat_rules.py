...
class VatRules(object):
    ...
    def get_sale_to_country_vat_charge(self, date, item_type, buyer, seller):
    ...
    def get_sale_from_country_vat_charge(self, date, item_type, buyer, seller):
...
class EuVatRulesMixin(object):
    ...
    def get_sale_to_country_vat_charge(self, date, item_type, buyer, seller):
        ...
        if seller.country_code == buyer.country_code or (
            ...
            return VatCharge(
                VatChargeAction.charge, buyer.country_code, self.get_vat_rate(item_type)
            )
        ...
        return VatCharge(VatChargeAction.reverse_charge, buyer.country_code, 0)
